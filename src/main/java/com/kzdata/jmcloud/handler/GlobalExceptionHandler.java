package com.kzdata.jmcloud.handler;

import com.kzdata.jmcloud.common.enums.GlobalExceptionCode;
import com.kzdata.jmcloud.common.exception.GlobalException;
...
public class GlobalExceptionHandler {
     ...
     * 将全部的异常参数拼接返回
     * @param request
     * @param exception 注解参数异常
     * @return
     * @throws Exception
     */
    @ExceptionHandler(MethodArgumentNotValidException.class)
    @ResponseBody
    public ReturnValueLoader methodArgumentNotValidExceptionHandler(HttpServletRequest request, MethodArgumentNotValidException exception) throws Exception {
